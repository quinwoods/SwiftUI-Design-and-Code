    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This text will have information on the pick up and will have an add to nightly route button")
                ...
                .lineSpacing(4)
            HStack(spacing: 20) {
                RingView(color1: #colorLiteral(red: 0.3411764801, green: 0.6235294342, blue: 0.1686274558, alpha: 1), color2: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), width: 88, height: 88, percent: 78, show: $show)
